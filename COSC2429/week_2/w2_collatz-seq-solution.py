...
equal_list = []
# the main for loop
# range(start,stop,step), note that stop is not inclusive, so we have to use 101
for N in range(1, 101, 1):
    ...
    while True:
        ...
        count += 1
    # pay attention to indentation, they will change the logic of your code
    ...
    if count == ori_N:
        # to add value to list, use the function append()
